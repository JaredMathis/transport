...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"for_each\": () => (/* binding */ for_each)\n/* harmony export */ });\nObject(function webpackMissingModule() { var e = new Error(\"Cannot find module './each/key.mjs'\"); e.code = 'MODULE_NOT_FOUND'; throw e; }());\n\nfunction for_each(list, lambda) {\n    Object(function webpackMissingModule() { var e = new Error(\"Cannot find module './each/key.mjs'\"); e.code = 'MODULE_NOT_FOUND'; throw e; }())(list, key => {\n        let l = list[key];\n        lambda(l, key);\n    });\n}\n\n//# sourceURL=webpack:///./node_modules/m00/src/for/each.mjs?");
